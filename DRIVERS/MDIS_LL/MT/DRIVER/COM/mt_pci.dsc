...
MT_PCI_1  {
    ...
    DEVICE_SLOT     = U_INT32       1             # used slot on baseboard
    IRQ_ENABLE      = U_INT32       0             # irq enabled after init

	#------------------------------------------------------------------------
	#	debug levels (optional)
	#------------------------------------------------------------------------
    DEBUG_LEVEL         = U_INT32   0x40008007    # LL driver
    DEBUG_LEVEL_MK      = U_INT32   0x40008007    # MDIS kernel
...
MT_PCI_2  {
	...
	SUBDEVICE_OFFSET_0 = U_INT32	0x8
	SUBDEVICE_OFFSET_1 = U_INT32	0x100
	#------------------------------------------------------------------------
	#	base board configuration
	#------------------------------------------------------------------------
    BOARD_NAME      = STRING        A11_OBPCMIP   # device name of baseboard
